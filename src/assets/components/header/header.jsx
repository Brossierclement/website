...
function Header() {
  ...
  return (
    <header className="header">
      ...
      <nav className={`navigation-mobile ${isActive ? "active" : ""}`}>
        <Link>À propos</Link>
        <Link>Projets</Link>
        <Link>Contact</Link>
      </nav>
